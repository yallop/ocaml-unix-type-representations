...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c3a16ae174677d1987b7283c8457f53) *)
(*
...
let setup_t =
  {
     ...
     test =
       [
          ("test_unix_type_representations",
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Expose the representations of the abstract types in the Unix module";
          description = None;
          categories = [];
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "unix_type_representations";
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["unix_type_representation_stubs.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Unix_representations"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "unix-type-representations";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "unix_type_representations"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
               ...
               Test
                 ({
                     cs_name = "test_unix_type_representations";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "/\144\203\030\1718}\224vseh\168\b!$";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
